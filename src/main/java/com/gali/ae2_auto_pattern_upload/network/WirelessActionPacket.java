...
import com.gali.ae2_auto_pattern_upload.wireless.WirelessWorldData;
...
public class WirelessActionPacket implements IMessage {
    ...
    public static class Handler implements IMessageHandler<WirelessActionPacket, IMessage> {
        ...
        private void handleToggleHighlight(TileWirelessTransceiver twt, EntityPlayerMP player) {
            ...
            boolean currentlyEnabled = com.gali.ae2_auto_pattern_upload.client.ClientState.highlightEnabled;
            if (currentlyEnabled) {
                ModNetwork.CHANNEL.sendTo(new WirelessHighlightPacket(new java.util.ArrayList<int[]>(), false), player);
            } else {
                java.util.List<com.gali.ae2_auto_pattern_upload.wireless.link.WirelessBlockLinkData> links = com.gali.ae2_auto_pattern_upload.wireless.link.WirelessBlockLinkManager
                    .instance()
                    .getAllLinks();
                java.util.List<int[]> positions = new java.util.ArrayList<int[]>();
                for (com.gali.ae2_auto_pattern_upload.wireless.link.WirelessBlockLinkData link : links) {
