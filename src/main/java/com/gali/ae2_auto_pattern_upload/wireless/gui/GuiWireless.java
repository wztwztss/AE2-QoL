...
import com.gali.ae2_auto_pattern_upload.network.WirelessActionPacket;
...
public class GuiWireless extends GuiContainer {
    ...
    public void initGui() {
        ...
        buttonList.add(
            new GuiButton(
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.add")));
        buttonList.add(
            new GuiButton(
                BTN_REMOVE,
                btnX2,
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.remove")));
        buttonList.add(
            new GuiButton(
                BTN_HIGHLIGHT,
                btnX3,
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.highlight")));
        buttonList.add(
            new GuiButton(
                BTN_SENDER,
                btnX1,
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.mode.sender")));
        buttonList.add(
            new GuiButton(
                BTN_RECEIVER,
                btnX2,
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.mode.receiver")));
        buttonList.add(
            new GuiButton(
                BTN_DISCONN,
                btnX3,
                ...
                BTN_W,
                BTN_H,
                StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.disconnect")));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        fontRendererObj.drawString(
            StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.freq") + ":",
            guiLeft + LIST_X,
            guiTop + 14,
            0xFFAAAAAA);
        ...
        String freqLabel = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.freq") + ": ";
        String freqVal = tile.getFrequency() != null && !tile.getFrequency()
            .isEmpty() ? tile.getFrequency()
                : EnumChatFormatting.GRAY + StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.none");
        ...
        String modeLabel = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.mode") + ": ";
        boolean isSender = tile.isMode();
        String modeVal = StatCollector.translateToLocal(
            isSender ? "gui.ae2_auto_pattern_upload.wireless.mode.sender"
                : "gui.ae2_auto_pattern_upload.wireless.mode.receiver");
        ...
        String connLabel = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.status") + ": ";
        boolean connected = tile.isConnected();
        boolean paused = tile.isPaused();
        String connVal;
        int connColor;
        if (paused) {
            connVal = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.status.paused");
            connColor = 0xFFFFAA00;
        } else if (connected) {
            connVal = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.status.connected");
            connColor = 0xFF26B938;
        } else {
            connVal = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.status.disconnected");
    ...
    private void drawDeleteConfirmDialog(int mouseX, int mouseY) {
        ...
        String confirmTitle = StatCollector.translateToLocal("gui.ae2_auto_pattern_upload.wireless.confirm_delete");
