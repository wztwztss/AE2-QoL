...
public class ItemWirelessConnector extends Item {
    ...
    public ItemWirelessConnector() {
        ...
        setTextureName("ae2_auto_pattern_upload:wireless_connect");
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
                ...
                if (twt.isMode()) {
                    ...
                    if (freq != null && !freq.isEmpty()) {
                        ...
                        player.addChatMessage(
                            new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.success", freq)
                                .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.GREEN)));
                    } else {
                        player.addChatMessage(
                            new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.no_channel")
                                .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
                    }
                } else {
                    player.addChatMessage(
                        new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.not_sender")
                            .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
                }
            }
            return true;
        ...
        if (boundFreq == null || boundFreq.isEmpty()) {
            player.addChatMessage(
                new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.no_binding")
                    .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
            return true;
        }
        ...
        if (te instanceof TileWirelessTransceiver) {
            ...
            twt.markDirty();
            player.addChatMessage(
                new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.connect.success", boundFreq)
                    .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.GREEN)));
            return true;
        }
        ...
        if (te instanceof TileCableBus || te instanceof IGridHost) {
            if (te.getWorldObj().provider.dimensionId != player.worldObj.provider.dimensionId) {
                player.addChatMessage(
                    new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.cross_dimension")
                        .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
                return true;
            }
            ...
            if (targetNode == null) {
                player.addChatMessage(
                    new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.no_grid")
                        .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
                return true;
            }
            ...
            for (WirelessBlockLinkData existing : WirelessBlockLinkManager.instance()
                ...
                if (posKey.equals(existing.getPositionKey())) {
                    ...
                    player.addChatMessage(
                        new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.unlink.success", boundFreq)
            ...
            player.addChatMessage(
                new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.blocklink.success", boundFreq)
                    .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.GREEN)));
            return true;
        }

        player.addChatMessage(
            new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.fail.invalid_target")
                .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
        return true;
    }
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        if (player.isSneaking()) {
            if (stack.stackTagCompound != null) {
                ...
                if (!world.isRemote) {
                    player.addChatMessage(
                        new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.bind.cleared")
                            .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.YELLOW)));
                }
            }
            return stack;
        ...
        if (!world.isRemote) {
            ...
            if (bound != null && !bound.isEmpty()) {
                player.addChatMessage(
                    new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.hint.use_device", bound)
                        .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
            } else {
                player.addChatMessage(
                    new ChatComponentTranslation("ae2_auto_pattern_upload.wireless.hint.bind_first")
                        .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
            }
        }
        return stack;
